...
{ src: '/pass/pass2.jpg', alt: 'Adventure 2' },
{ src: '/pass/pass3.jpg', alt: 'Adventure 3' },
{ src: '/pass/pass4.webp', alt: 'Adventure 4' },
{ src: '/pass/pass5.jpg', alt: 'Adventure 5' },
{ src: '/pass/pass6.webp', alt: 'Adventure 6' },
{ src: '/destination/nepal.jpg', alt: 'Adventure 7' },
{ src: '/destination/dubai.jpg', alt: 'Adventure 8' },
{ src: '/destination/bhutan.jpg', alt: 'Adventure 9' },
{ src: '/destination/vietnam.jpg', alt: 'Adventure 10' },
{ src: '/destination/ANDAMAN.jpg', alt: 'Adventure 11' },
{ src: '/destination/inter.jpg', alt: 'Adventure 12' },
];
const treks = [
...
const faqContent = {
  ...
  const [activeTab, setActiveTab] = useState<keyof FaqContent>(tabs[0] as keyof FaqContent);
...
onClick={() => setActiveTab(tab as keyof FaqContent)}
>
{tab}
</button>
))}
